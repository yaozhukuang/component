package com.zw.yzk.component.widget.toast;
...
import com.zw.yzk.component.widget.R;
...
public class Toasty {
    ...
    Toast warning(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.component_widget_ic_error_outline_white_48dp),
    ...
    Toast info(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.component_widget_ic_info_outline_white_48dp),
    ...
    Toast success(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.component_widget_ic_check_white_48dp),
    ...
    Toast error(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.component_widget_ic_clear_white_48dp),
    ...
    Toast custom(@NonNull Context context, @NonNull String message, Drawable icon,
        ...
        final View toastLayout = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(R.layout.component_widget_layout_toast, null);
        ...
        if (shouldTint) {
            ...
            drawableFrame = ToastyUtils.getDrawable(context, R.drawable.component_widget_im_toast_frame);
        }
